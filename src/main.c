...
extern char *Rust_HL_keywords[];
extern char *Rust_HL_extensions[];

extern char *Lua_HL_keywords[];
extern char *Lua_HL_extensions[];

extern char *TS_HL_keywords[];
extern char *TS_HL_extensions[];
extern char *TSX_HL_extensions[];

extern char *Zig_HL_keywords[];
extern char *Zig_HL_extensions[];

extern char *TOML_HL_keywords[];
extern char *TOML_HL_extensions[];
...
struct syntax HLDB[] = {
    ...
    {"typescript", TS_HL_extensions, TS_HL_keywords, "//", "/*", "*/",
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"tsx", TSX_HL_extensions, TS_HL_keywords, "//", "/*", "*/",
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"zig", Zig_HL_extensions, Zig_HL_keywords, "//", "/*", "*/",
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"toml", TOML_HL_extensions, TOML_HL_keywords, "#", NULL, NULL,
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"nix", Nix_HL_extensions, Nix_HL_keywords, "#", "/*", "*/",
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"cmake", CMake_HL_extensions, CMake_HL_keywords, "#", "#[[", "]]",
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"riscv", RiscV_HL_extensions, RiscV_HL_keywords, "#", NULL, NULL,
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"csharp", CS_HL_extensions, CS_HL_keywords, "//", "/*", "*/",
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"makefile", Make_HL_extensions, Make_HL_keywords, "#", NULL, NULL,
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
    {"v", V_HL_extensions, V_HL_keywords, "//", "/*", "*/",
     HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
};
